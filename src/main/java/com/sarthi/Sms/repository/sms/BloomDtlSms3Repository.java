...
import com.sarthi.Sms.entity.sms.BloomDtlSms3Entity;
...
@Repository
public interface BloomDtlSms3Repository extends JpaRepository<BloomDtlSms3Entity, String> {
    @Query(value = """
            SELECT
            ...
            FROM heat_detail_sms3 shd
            JOIN duty_heat_sms3 sdh ON shd.heat_number = sdh.heat_number
