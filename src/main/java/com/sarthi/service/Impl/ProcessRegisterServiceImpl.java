...
public class ProcessRegisterServiceImpl implements ProcessRegisterService {
    ...
    private List<String> getHourLabelsForShift(String shift) {
        if (shift == null) return Arrays.asList("05:00-06:00", "06:00-07:00", "07:00-08:00", "08:00-09:00", "09:00-10:00", "10:00-11:00", "11:00-12:00", "12:00-13:00", "13:00-14:00", "14:00-15:00", "15:00-16:00", "16:00-17:00");
        String s = shift.toLowerCase();
        if (s.contains("2") || s.contains("ii") || s.contains("second") || s.contains("b")) {
            // Shift B (13:00 - 23:55)
            return Arrays.asList("13:00-14:00", "14:00-15:00", "15:00-16:00", "16:00-17:00", "17:00-18:00", "18:00-19:00", "19:00-20:00", "20:00-21:00", "21:00-22:00", "22:00-23:00", "23:00-23:55");
        } else if (s.contains("3") || s.contains("iii") || s.contains("third") || s.contains("c")) {
            // Shift C (22:00 - 09:00)
            return Arrays.asList("22:00-23:00", "23:00-00:00", "00:00-01:00", "01:00-02:00", "02:00-03:00", "03:00-04:00", "04:00-05:00", "05:00-06:00", "06:00-07:00", "07:00-08:00", "08:00-09:00");
        } else if (s.contains("g") || s.contains("general")) {
            // General Shift (08:00 - 20:00)
            return Arrays.asList("08:00-09:00", "09:00-10:00", "10:00-11:00", "11:00-12:00", "12:00-13:00", "13:00-14:00", "14:00-15:00", "15:00-16:00", "16:00-17:00", "17:00-18:00", "18:00-19:00", "19:00-20:00");
        }
        // Default to Shift A (05:00 - 17:00)
        return Arrays.asList("05:00-06:00", "06:00-07:00", "07:00-08:00", "08:00-09:00", "09:00-10:00", "10:00-11:00", "11:00-12:00", "12:00-13:00", "13:00-14:00", "14:00-15:00", "15:00-16:00", "16:00-17:00");
    }
