...
@RestController
@RequestMapping("/api/aggregate-flakiness")
public class AggregateFlakinessController {

    @Autowired
    private AggregateFlakinessService service;

    @PostMapping
    public ResponseEntity<Object> create(@RequestBody AggregateFlakinessRequestDto dto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> update(@PathVariable Long id, @RequestBody AggregateFlakinessRequestDto dto) {
        return new ResponseEntity<>(
