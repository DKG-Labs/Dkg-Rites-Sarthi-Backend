...
@RestController
@RequestMapping("/api/cement-fineness")
public class CementFinenessController {

    @Autowired
    private CementFinenessService service;

    @PostMapping
    public ResponseEntity<Object> create(@RequestBody CementFinenessRequestDto dto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> update(@PathVariable Long id, @RequestBody CementFinenessRequestDto dto) {
        return new ResponseEntity<>(
