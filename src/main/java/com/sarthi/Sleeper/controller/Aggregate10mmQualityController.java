...
@RestController
@RequestMapping("/api/aggregate-10mm-quality")
public class Aggregate10mmQualityController {

    @Autowired
    private Aggregate10mmQualityService service;

    @PostMapping
    public ResponseEntity<Object> create(@RequestBody Aggregate10mmQualityRequestDto dto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> update(@PathVariable Long id, @RequestBody Aggregate10mmQualityRequestDto dto) {
        return new ResponseEntity<>(
