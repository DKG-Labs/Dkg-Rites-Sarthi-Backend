...
@RestController
@RequestMapping("/api/aggregate-granulometric")
public class AggregateGranulometricController {

    @Autowired
    private AggregateGranulometricService service;

    @PostMapping
    public ResponseEntity<Object> create(@RequestBody AggregateGranulometricRequestDto dto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> update(@PathVariable Long id, @RequestBody AggregateGranulometricRequestDto dto) {
        return new ResponseEntity<>(
