...
/**
 * Entity representing Sleeper Call Cancellation Details.
 * Stores call cancellation fields, calculation results, and document references.
 */
@Entity
@Table(name = "sleeper_call_cancellation_details", indexes = {
    @Index(name = "idx_sleeper_cancellation_call_no", columnList = "call_number"),
    @Index(name = "idx_sleeper_cancellation_vendor_code", columnList = "vendor_code")
})
@Data
@EqualsAndHashCode(callSuper = true)
public class SleeperCallCancellationDetail extends BaseAuditEntity {
