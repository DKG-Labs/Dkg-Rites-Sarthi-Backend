...
public class reportsController {
        ...
        public ResponseEntity<Object> getInspectionDataBasedOnSerialNo(
                ...
                Page<PoInspection3rdLevelCallStatusDto> result = reportService.getCallWiseStatusBySerialNo(poNo, callNo,
                                page,
                                size);
                ;
        ...
        public ResponseEntity<Object> getDashboardSummary(
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getDashboardSummary(vendorPlantCode, zonalRailway,
                                                                startDate, endDate)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getRailPadClosedLoopPlants(@RequestParam String vendorCode) {
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getRailPadClosedLoopPlants(vendorCode)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getRailPadClosedLoopLots(@RequestParam String plantId, @RequestParam int year) {
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getRailPadClosedLoopLots(plantId, year)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getAvgProductionPerDay(
                ...
                if (startDate != null && endDate != null) {
                        return new ResponseEntity<Object>(
                                        ResponseBuilder.getSuccessResponse(
                                                        reportService.getAvgProductionPerDayWithFilters(startDate,
        ...
        public ResponseEntity<Object> getQualityRejection(
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getStageWiseRejection(startDate, endDate)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getManufacturerRejection(
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getManufacturerRejection(startDate, endDate)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getProcessPerformance(
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getProcessPerformance(startDate, endDate)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getDailyRejectionTrend(@RequestParam(required = false) String startDate,
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getDailyRejectionTrend(startDate, endDate)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getManufacturingStepWiseRejection(
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getManufacturingStepWiseRejection(startDate, endDate)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getInspectionCallStatus(
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getInspectionCallStatus(vendorPlantCode, zonalRailway,
        ...
        public ResponseEntity<Object> getParetoAnalysis(@RequestParam(required = false) String startDate,
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getParetoAnalysis(startDate, endDate, product)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getInspectionDetails(@RequestParam(required = false) String startDate,
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getInspectionDetails(startDate, endDate, vendorPlantCode,
                                                                zonalRailway, product)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getPoIssuedDetails(
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getPoIssuedDetails(itemCatDescr, vendorPlantCode,
        ...
        public ResponseEntity<Object> getInspectionCallStatusDetails(
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getInspectionCallStatusDetails(stage, status,
        ...
        public ResponseEntity<Object> getRailPadShiftWiseProduction(
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getRailPadShiftWiseProductionReport(startDate, endDate,
                                                                vendor, plant)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getRailPadVendorWiseQuality(
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getRailPadVendorWiseQualityReport(startDate, endDate)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getRailPadQualityReport(
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getRailPadQualityReport(startDate, endDate)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getCmOverDueErcCalls(
                ...
                List<InspectionCallsReportDto> list = reportService.getOverduePendingInspectionCallsReport(startDate,
                                endDate);
        ...
        public ResponseEntity<Object> getCmIeWiseCallStatus(@RequestParam(required = false) String cmEmpId) {
                ...
                List<IeWiseCallStatusWorkloadSummaryDto> list = reportService
                                .getIeWiseCallStatusWorkloadSummary(cmEmpId);
        ...
        public ResponseEntity<Object> getCmIeCompletedCalls(@RequestParam(required = false) String cmEmpId) {
                ...
                List<IeOperationalSlaPerformanceSummaryDto> list = reportService
                                .getIeOperationalSlaPerformanceSummary(cmEmpId);
        ...
        public ResponseEntity<Object> getTotalCallsDashboardSummary(
                ...
                return new ResponseEntity<Object>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getTotalCallsSummary(vendorPlantCode, zonalRailway,
                                                                startDate, endDate)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getOpenCalls(
                ...
                return new ResponseEntity<>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getOpenCalls(vendorPlantCode, zonalRailway, startDate,
                                                                endDate)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getUnderInspectionCalls(
                ...
                return new ResponseEntity<>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getUnderInspectionCalls(vendorPlantCode, zonalRailway,
                                                                startDate, endDate)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Object> getPendingCalls(
                ...
                return new ResponseEntity<>(
                                ResponseBuilder.getSuccessResponse(
                                                reportService.getPendingCalls(vendorPlantCode, zonalRailway, startDate,
                                                                endDate)),
                                HttpStatus.OK);
        }
