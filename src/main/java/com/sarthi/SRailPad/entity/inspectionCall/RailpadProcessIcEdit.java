...
/**
 * Stores the e-sign / signed data for Process Inspection Certificate.
 * Populated when the IE clicks E-SIGN IC.
 */
@Entity
@Table(name = "railpad_process_ic_edit", indexes = {
    @Index(name = "idx_rpad_pic_edit_ic_no", columnList = "ic_number", unique = true)
})
@Data
public class RailpadProcessIcEdit {
