...
/**
 * Entity representing Railpad SRS Call Cancellation Details.
 * Stores call cancellation fields, calculation results, and document references.
 */
@Entity
@Table(name = "rail_call_cancellation_details", indexes = {
    @Index(name = "idx_rail_cancellation_call_no", columnList = "call_number"),
    @Index(name = "idx_rail_cancellation_vendor_code", columnList = "vendor_code")
})
@Data
@EqualsAndHashCode(callSuper = true)
public class RailCallCancellationDetail extends BaseAuditEntity {
